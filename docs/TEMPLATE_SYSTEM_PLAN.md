...
- progress:
  ...
  - 2026-04-10: business and platform presets started enabling those shell modules by default, so preset behavior now affects the rendered shell as well as content and schema
